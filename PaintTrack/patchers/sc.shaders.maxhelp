...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 575.0, 153.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.syphonserver shaders"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.0, 57.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "r video"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 833.0, 416.0, 159.0, 125.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 289.0, 148.0, 147.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 629.0, 271.5, 201.0, 165.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 629.0, 463.0, 202.0, 107.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 198.0, 377.0, 196.0, 133.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 629.0, 11.0, 229.0, 244.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 268.0, 575.0, 249.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 37.0, 249.5, 206.0, 22.0 ],
					"style" : "",
...
,
					...
					"output_texture" : 1,
					"patching_rect" : [ 259.0, 9.0, 150.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 12.0, 148.0, 145.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 93.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Desktop/shaders/media",
				"type" : "mpg4",
				"implicit" : 1
			}
, 			{
				"name" : "sc.fold.mirror.maxpat",
				"bootpath" : "~/Documents/Max 7/Packages/DrawingPatchAME/Shaders/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
